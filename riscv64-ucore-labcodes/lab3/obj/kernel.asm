...
ffffffffc0203132:	e79c                	sd	a5,8(a5)
...
ffffffffc02033ea:	7d250513          	addi	a0,a0,2002 # ffffffffc0205bb8 <default_pmm_manager+0xaa0>
...
ffffffffc020341a:	78268693          	addi	a3,a3,1922 # ffffffffc0205b98 <default_pmm_manager+0xa80>
ffffffffc020341e:	00002617          	auipc	a2,0x2
ffffffffc0203422:	94a60613          	addi	a2,a2,-1718 # ffffffffc0204d68 <commands+0x738>
ffffffffc0203426:	04800593          	li	a1,72
...
ffffffffc020343a:	77268693          	addi	a3,a3,1906 # ffffffffc0205ba8 <default_pmm_manager+0xa90>
...
ffffffffc0203456:	0000e697          	auipc	a3,0xe
ffffffffc020345a:	1026b683          	ld	a3,258(a3) # ffffffffc0211558 <curr_ptr>
    list_entry_t *head = (list_entry_t *)mm->sm_priv;
ffffffffc020345e:	751c                	ld	a5,40(a0)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203460:	ce81                	beqz	a3,ffffffffc0203478 <_clock_map_swappable+0x22>
    __list_add(elm, listelm->prev, listelm);
ffffffffc0203462:	6394                	ld	a3,0(a5)
ffffffffc0203464:	03060713          	addi	a4,a2,48
    prev->next = next->prev = elm;
ffffffffc0203468:	e398                	sd	a4,0(a5)
ffffffffc020346a:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc020346c:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc020346e:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc0203470:	fa14                	sd	a3,48(a2)
ffffffffc0203472:	ea1c                	sd	a5,16(a2)
}
...
ffffffffc020348a:	03600593          	li	a1,54
...
ffffffffc0203578:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
